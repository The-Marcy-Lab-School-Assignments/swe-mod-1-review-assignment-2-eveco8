...
const availableTitles = books.map(book => {
...
const totalCheckouts = books.reduce((acc, book) => (book.checkouts + acc), 0);
...
const mostCheckouts = books.reduce((acc /*max*/, book) => {
  if (book.checkouts > acc /*max*/) {
